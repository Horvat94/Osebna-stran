...
var dropDownMenu = new _DropDownMenu2.default();
...
var DropDownMenu = function () {
	function DropDownMenu() {
		...
		this.logoHeader = (0, _jquery2.default)(".site-header__logo");
		this.dropDownMenu = (0, _jquery2.default)(".site-header__drop-down-menu");
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.siteHeader = (0, _jquery2.default)(".site-header");
		this.logoHeader = (0, _jquery2.default)(".site-header__logo");
		this.contentNavMobile = (0, _jquery2.default)(".site-header__menu-content");
		this.navHeader = (0, _jquery2.default)(".primary-nav");
		this.trigerElement = (0, _jquery2.default)(".large-hero__author");
		this.headerLinks = (0, _jquery2.default)(".primary-nav a");
		this.footerLinks = (0, _jquery2.default)(".footer__nav-main a");
		this.pageSections = (0, _jquery2.default)(".page-section");
		this.heroPage = (0, _jquery2.default)(".large-hero__title");
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						...
						if (direction == "down") {
							...
							(0, _jquery2.default)(matchHeaderlink).addClass("is-current-link");
						}
					},
					offset: "50%"
				});
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						...
						if (direction == "up") {
							...
							(0, _jquery2.default)(matchHeaderlink).addClass("is-current-link"); //poiščemo po id-ju odsek in mu dodamo razred
						}
					},
					offset: "-40%"
				});
